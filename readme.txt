...
Prerequiste: Node.js 8+ should be installed.

The PrintNumbers.js file takes in limit as command line argument and 
prints first N prime numbers and fibonacci numbers parallely using Promises
